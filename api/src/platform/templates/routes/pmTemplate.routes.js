...
import { pmTemplateService } from '../../../core/solutioning/services/pmTemplateService.js';
 ...
 */
router.get('/:orgId/pm-templates', requireMember('viewer', 'admin'), async (req, res) => {
  try {
 ...
 */
router.get('/:orgId/pm-templates/:templateId', requireMember('viewer', 'admin'), async (req, res) => {
  try {
 ...
 */
router.post('/:orgId/pm-templates', requireMember('reviewer', 'admin'), async (req, res) => {
  try {
    const { orgId } = req.params;
 ...
 */
router.put('/:orgId/pm-templates/:templateId', requireMember('reviewer', 'admin'), async (req, res) => {
  try {
    const { orgId, templateId } = req.params;
    const templateData = req.body;
 ...
 */
router.delete('/:orgId/pm-templates/:templateId', requireMember('admin'), async (req, res) => {
  try {
    const { orgId, templateId } = req.params;
 ...
 */
router.get('/:orgId/pm-templates/:templateId/usage', requireMember('viewer', 'admin'), async (req, res) => {
  try {
    const { orgId, templateId } = req.params;
 ...
 */
router.post('/:orgId/pm-templates/:templateId/duplicate', requireMember('reviewer', 'admin'), async (req, res) => {
  try {
    const { orgId, templateId } = req.params;
    const { name } = req.body;
